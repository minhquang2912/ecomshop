    ...
    <div class="row">
        <aside class="col-sm-5 border-right">
            ...
            <div class="img-big-wrap">
              <div> <a href="#">
                <img src="{{Storage::url($product->image)}}" style="width:100% !important;height:300px !important" ></a>
              </div>
            </div> 
      ...
      @foreach($productFromSameCategories as $product)
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="{{Storage::url($product->image)}}" style="width:100% !important;height:300px !important">
